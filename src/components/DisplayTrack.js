...
const DisplayTrack = ({
    ...
    useEffect(() => {
        setLiked(false);
        console.log("like button is enabled");
    }, [currentTrack.title])
        ...
        <div>
            ...
            <div className="text">
                <p className="title">{currentTrack.title}
                    <span className="likes1"><button onClick={handleLikesClick} disabled={liked}
                                                     name="likedBtn"><ThumbUpIcon/></button>
                        {currentTrack.likesCount}</span>
                </p>
